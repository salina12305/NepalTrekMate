...
const GuideProfile = () => {
  /**
   * ROUTING & NAVIGATION
   * useParams(): Extracts the ':id' part of the URL (e.g., /profile/123)
   * useNavigate(): Allows us to programmatically move the user back or to other pages
   */
  const { id } = useParams(); 
  ...
  /**
   *  DATA FETCHING
   * This effect runs every time the 'id' in the URL changes.
   */
  useEffect(() => {
  ...
  return (
    <div className="p-8 bg-slate-50 min-h-screen">
      {/* Navigation Button: navigate(-1) takes the user to the previous page in history */}
      ...
      <div className="bg-white rounded-[2.5rem] p-10 shadow-sm border border-slate-200 max-w-4xl mx-auto">
        <div className="flex flex-col md:flex-row gap-10 items-center">
          ...
          <div>
            ...
            {/* Added a dummy location for visual completeness */}
